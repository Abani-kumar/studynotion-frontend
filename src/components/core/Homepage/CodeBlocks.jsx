...
const CodeBlocks = ({
  ...
  return (
    <div
      className=" flex lg:flex-row flex-col gap-10 items-center mt-32"
    >
      {/*Section 1*/}
      <div className="md:w-[50%] sm:w-[95%] flex flex-col gap-8">
        {heading}
      ...
      <div className=" h-fit  flex flex-row text-10[px] w-[100%] py-4 lg:w-[500px] border border-[rgb(220,20,60,0.5)] bg-[rgba(20,160,220,0.3)]">
        ...
        <div
          className={`w-[90%] flex flex-col gap-2 font-bold font-mono ${codeColor} pr-2 z-20`}
        >
          <TypeAnimation
